...
def create_base_output(first_run):
    if first_run==1:
        ...
        data = pd.read_csv(address + "site_file_weekly_canada.csv")
    for r in range(1,10+1):
        temp = pd.read_csv(address + "site_file_weekly_canada r = "+str(r)+".csv")
    ...
    data.to_csv(address + 'site_file_weekly_canada.csv',index = False)
...
#         regular_data.to_csv(address + str(h)+'-'+str(r)+'regular_data.csv',index=False)
        ...
        daily_site_csv.to_csv(address + "site_file_daily_Canada.csv", index=False)

        weekly_site_csv = create_site_csv(weekly_output_csv, 'weekly', r)
        weekly_site_csv.to_csv(address + "site_file_weekly_Canada r = "+str(r)+".csv", index=False)
