...
if target_mode == 'weeklyaverage':maxHistory = 5 * 7
if target_mode == 'regular':maxHistory = 10
...
def real_prediction_plot(df, r, test_size, target_name, target_mode, best_h, maxHistory, spatial_mode, methods,
    ...
    for method in methods:
        ...
        if target_mode != 'weeklyaverage':
            ...
            df_for_plot['date'] = df_for_plot['date'].apply(lambda x: datetime.datetime.strftime(x, '%y/%m/%d'))
        else:
...
if __name__ == "__main__":
    ...
    validation_address = './canada/' + target_mode + '/' + str(r) + '/' + str(end_date) + '/results/counties=' + str(numberOfSelectedCountiesname) + '/validation/'
    test_address = './canada/' + target_mode + '/' + str(r) + '/' + str(end_date) + '/results/counties=' + str(numberOfSelectedCountiesname) + '/test/'
    env_address = './canada/' + target_mode + '/' + str(r) + '/' + str(end_date) + '/results/counties=' + str(numberOfSelectedCountiesname) + '/session_parameters/'
    mail_address = './canada/' + target_mode + '/' + str(r) + '/' + str(end_date) + '/results/counties=' + str(numberOfSelectedCountiesname) + '/email'
